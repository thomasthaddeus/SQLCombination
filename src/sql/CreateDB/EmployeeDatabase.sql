...
CREATE VIEW IF NOT EXISTS Employee_Job AS
SELECT
...
VALUES
    (3, 2, 'General Manager', 180000.00, NULL, 30.0);
...
VALUES
    (6, 4, 'Accountant', 90000.00, NULL, 10.0);
...
VALUES
    (7, 5, 'QA Engineer', 80000.00, NULL, 10.0);
...
VALUES
    (9, 7, 'Sales Manager', 70000.00, 30.0, NULL);
...
VALUES
    (10, 8, 'IT Specialist', 95000.00, NULL, 10.0);
...
VALUES
    (11, 9, 'Receptionist', 55000.00, NULL, 10.0);
...
VALUES
    (12, 10, 'Office Manager', 60000.00, NULL, 10.0);
